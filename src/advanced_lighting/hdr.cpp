...
int main()
{
    Application app("High Dynamic Range(HDR)");
    ...
    // -------------------------
    Shader shader("shaders/hdr/lighting_vertx.glsl", "shaders/hdr/lighting_frag.glsl");
    Shader hdr_shader("shaders/hdr/hdr_vertx.glsl", "shaders/hdr/hdr_frag.glsl");
    ...
    while (!glfwWindowShouldClose(app.window))
    {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, hdrFBO);
            glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
            glm::mat4 projection = glm::perspective(glm::radians(Application::camera.Zoom), (GLfloat)D_WIDTH / (GLfloat)D_HEIGHT, 0.1f, 100.0f);
