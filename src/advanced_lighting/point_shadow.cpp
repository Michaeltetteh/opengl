...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/point_shadow/point_shadows_vertx.glsl", "shaders/point_shadow/point_shadows_frag.glsl");
    Shader simpleDepthShader("shaders/point_shadow/point_shadows_depth_vertx.glsl", "shaders/point_shadow/point_shadows_depth_frag.glsl", "shaders/point_shadow/point_shadows_depth_geo.glsl");    
