...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/bloom/bloom_vertx.glsl", "shaders/bloom/bloom_frag.glsl");
    Shader shaderLight("shaders/bloom/bloom_vertx.glsl", "shaders/bloom/lightbox_frag.glsl");
    Shader shaderBlur("shaders/bloom/blur_vertx.glsl", "shaders/bloom/blur_frag.glsl");
    Shader shaderBloomFinal("shaders/bloom/bloomfinal_vertx.glsl", "shaders/bloom/bloomfinal_frag.glsl");
