...
int main()
{
    ...
    // ------------------------------------
    Shader cubeShader("shaders/directional_light/cubeVertex.shader","shaders/directional_light/cubeFrag.shader");
    Shader lightShader("shaders/directional_light/lightVertex.shader","shaders/directional_light/lightFrag.shader");
