...
int main()
{
    ...
    // ------------------------------------
    Shader cubeShader("shaders/specularMap/cubeVertex.shader","shaders/specularMap/cubeFrag.shader");
    Shader lightShader("shaders/specularMap/lightVertex.shader","shaders/specularMap/lightFrag.shader");
