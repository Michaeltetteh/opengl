...
int main()
{
    ...
    // ------------------------------------
    Shader cubeShader("shaders/point_light/cubeVertex.shader","shaders/point_light/cubeFrag.shader");
    Shader lightShader("shaders/point_light/lightVertex.shader","shaders/point_light/lightFrag.shader");
