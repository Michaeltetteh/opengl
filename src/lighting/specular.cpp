...
int main()
{
    ...
    // ------------------------------------
    Shader cubeShader("shaders/specular/cubeVertex.shader","shaders/specular/cubeFrag.shader");
    Shader lightShader("shaders/specular/lightVertex.shader","shaders/specular/lightFrag.shader");
